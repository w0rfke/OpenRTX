...
// LCD display
#define LCD_CLK GPIOA, 5
#define LCD_DAT GPIOA, 7
#define LCD_CS GPIOA, 6
//#define LCD_PWR GPIOB, 7
#define LCD_DC GPIOA, 4
...
#define BK1080_DAT GPIOB, 10  // Shared with external flash SCK
#define BK1080_EN GPIOC, 9

// BK4819
#define BK4819_CLK GPIOC, 10
